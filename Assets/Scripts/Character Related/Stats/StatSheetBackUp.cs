...
namespace dnSR_Coding
{
    ...
    public class StatSheetBackUp : ScriptableObject, IDebuggable
    {
        ...
        private void SetSubStatsValues()
        {
            ...
            int strengthPts = ( int ) GetStatByType( StatType.Strength ).GetValue( GetStatByType( StatType.Strength ).InitialValue );
            int endurancePts = ( int ) GetStatByType( StatType.Endurance ).GetValue( GetStatByType( StatType.Endurance ).InitialValue );
            int dexterityPts = ( int ) GetStatByType( StatType.Dexterity ).GetValue( GetStatByType( StatType.Dexterity ).InitialValue );
