            ...
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        //Debug.Debug("Start Word Region at [" + currentCharInfo.character + "]");
                        ...
                        if (wInfo.characterCount == 1)
                        {
                            ...
                            //Debug.Debug("End Word Region at [" + currentCharInfo.character + "]");
                        }
                    }
                ...
                //Debug.Debug(wInfo.GetWord(m_TextMeshPro.textInfo.characterInfo));
            }
